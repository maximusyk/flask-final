...
Revision ID: 64446d96b64b
Revises: 
Create Date: 2021-05-06 21:33:56.589091
...
def upgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        batch_op.add_column(sa.Column('date_created', sa.String(), nullable=True))
...
def downgrade():
    ...
    sa.Column('image_file', sa.VARCHAR(), nullable=False),
    sa.Column('last_seen', sa.VARCHAR(), nullable=True),
